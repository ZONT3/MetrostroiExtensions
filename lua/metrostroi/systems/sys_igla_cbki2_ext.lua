...
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("IGLA_CBKI2_EXT")
...
function TRAIN_SYSTEM:Initialize()
    ...
    if not self.Train.IGLA1U then
        self.Train:LoadSystem("IGLA1U", "Relay", "Switch", {
            bass = true
        })
        ...
        self.Train:LoadSystem("IGLA1D", "Relay", "Switch", {
            bass = true
        })

        self.Train:LoadSystem("IGLA2U", "Relay", "Switch", {
            bass = true
        })
        ...
        self.Train:LoadSystem("IGLA2D", "Relay", "Switch", {
            bass = true
        })
    end

    self.TriggerNames = {"IGLA1U", "IGLA1", "IGLA1D", "IGLA2U", "IGLA2", "IGLA2D",}
    self.Triggers = {}
    self.State = -2
end
    ...
    function TRAIN_SYSTEM:Trigger(name, value)
        if self.State == 2 then
            if self.State2 == 0 then
                ...
                if name == "IGLA2" and value then self.State = -2 end
            elseif self.State2 == 1 then
                self.StandbyTimer = CurTime()
                if name == "IGLA1" and value and self.Selected > 1 then self.Selected = self.Selected - 1 end
                if name == "IGLA2" and value then self.State2 = 0 end
                if name == "IGLA2U" and value and self.Selected < #self.Log then self.Selected = self.Selected + 1 end
            elseif self.State2 == 2 then
                self.StandbyTimer = CurTime()
                if name == "IGLA1D" and value and self.Selected > 1 then self.Selected = self.Selected - 1 end
                if name == "IGLA1" and value then self.State2 = 0 end
                if name == "IGLA1U" and value and self.Selected < #self.Messages then self.Selected = self.Selected + 1 end
            end
        end
    end
    ...
    function TRAIN_SYSTEM:Think(dT)
        ...
        elseif self.State == 2 then
            ...
            if self.MessagesCount ~= #self.Messages then
                ...
                if self.State2 == 2 and mess == 0 then self.State2 = 0 end
