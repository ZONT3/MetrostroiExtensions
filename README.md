...
Конечно, не обязательно каждую строчку покрывать комментариями, но если твой рецепт делает несколько вещей - раздели и подпиши, за что каждая часть отвечает
