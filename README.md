...
У внимательного читателя возникнет вопрос: "а в какой тип состава инжектится?". Необходимо инжектится в головной вагон - таким образом вы избежите проблем с задвоением в спавнере.
## Методы
